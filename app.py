...
st.markdown("""
    ...
    div[data-baseweb="select"] > div { background-color: #ffffff !important; border-radius: 8px !important; font-weight: 700 !important; color: #0f172a !important; }
    ...
    .app-title { color: #0f172a !important; font-size: 16px; font-weight: 700; line-height: 1.4; }
    ...
    /* Perbaikan Tab/Expander Agar Tidak Gelap Saat Diklik */
    ...
    td { background-color: #ffffff !important; color: #0f172a !important; border-bottom: 1px solid #f1f5f9 !important; }
    
    header { display: none !important; } #MainMenu { display: none !important; } footer { display: none !important; }
    
    /* Signature Vertikal Tanpa Singkatan */
    .sign-container { 
        display: block; 
        text-align: center; 
        font-size: 10px; 
...
try:
    ...
    try:
        ...
        st.error(f"File '{DAFTAR_PROJECT[selected_project]}' tidak ditemukan di Google Sheets.")
        st.stop()
    ...
    # AREA TANDA TANGAN (FULL NAMA TANPA SINGKATAN)
    st.markdown("""
